...
<body>
  <main class="container">
    ...
    <form method="post" class="card" style="max-width:420px">
        <table>
            <tr>
                <label><td>ログインID</td><td><input name="user" required></td></label>
            </tr>
            <tr>
                <label><td>パスワード</td><td><input type="password" name="pass" required></td></label>
            </tr>
            <tr>
                <td><button class="btn primary" type="submit">ログイン</button></td>
                <td><a class="btn" href="index.html">戻る</a></td>
            </tr>
        </table>
    </form>
